...
@section('content')
                      ...
                      <!-- My attended events start from here. -->
                                            ...
                                            <table class="table table-user-information">
                                                ...
                                                @foreach ($attendedEvents as $attendedEvent)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><p><a href="/joinEvent/{{ $attendedEvent->id }}">{{ $attendedEvent->title }}</a></p><p>{{ date('M j, Y, g:i a', strtotime($attendedEvent->dateTime)) }}</p></td>
