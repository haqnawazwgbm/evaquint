...
@section('content')
 <h3>Events Your Attended</h3>
                        <table class="table table-user-information">
                            <tbody>
                            @foreach ($attendingEvents as $attendedEvent)

                                <tr>
                                    <td><a  href="/map/{{ $attendedEvent->id }}"><img data-toggle="tooltip" dattendingEventsata-original-title="Click to show event on map" src="/img/marker.png" /></a></td>
